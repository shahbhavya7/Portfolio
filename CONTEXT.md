...
## Current Status
Experience section: Castorini removed. Now has 2 entries (Calfus — current, Info Origin — completed).
Section is fully dynamic — add/remove from EXPERIENCES array only, zero JSX changes needed.
Next: Opus Phase 3 craft pass.
